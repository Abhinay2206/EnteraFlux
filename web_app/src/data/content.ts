...
export const AUDIENCE_CTAS = [
    {
        ...
        description: 'Are you using or considering GLP-1 medication in India? Your feedback helps us build a better wellness companion for everyone.',
        cta: 'Give Feedback',
        href: '/contact',
    },
    {
    ...
    },
    {
        ...
        title: 'Join Our R&D',
        description: 'Want to contribute to wellness tech research? Join our R&D team and help build tools that make a real difference.',
        cta: 'Apply Now',
        href: '/contact?tab=rnd',
    },
    {
